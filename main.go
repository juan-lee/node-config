...
import (
	...
	"github.com/juan-lee/node-config/apis/config/scheme"
	v1 "github.com/juan-lee/node-config/apis/config/v1"
...
func populateV1Defaults(cfg *config.NodeConfiguration) error {
	// Create a new config of some external version,
	// default it, convert it into the internal version
	v1cfg := &v1.NodeConfiguration{
		ContainerRuntimeConfiguration: v1.ContainerRuntimeConfiguration{},
	}
